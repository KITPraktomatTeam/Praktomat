...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attestation.published_on'
        db.add_column('attestation_attestation', 'published_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attestation.published_on'
        db.delete_column('attestation_attestation', 'published_on')
