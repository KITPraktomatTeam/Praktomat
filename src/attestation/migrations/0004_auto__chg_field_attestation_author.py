...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attestation.author'
        db.alter_column('attestation_attestation', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))


    def backwards(self, orm):
        
        # Changing field 'Attestation.author'
        db.alter_column('attestation_attestation', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
