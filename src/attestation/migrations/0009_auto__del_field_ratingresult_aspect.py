...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RatingResult.aspect'
        db.delete_column('attestation_ratingresult', 'aspect_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RatingResult.aspect'
        raise RuntimeError("Cannot reverse this migration. 'RatingResult.aspect' and its values cannot be restored.")
