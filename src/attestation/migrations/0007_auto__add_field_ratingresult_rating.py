...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RatingResult.rating'
        db.add_column('attestation_ratingresult', 'rating', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['attestation.Rating']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RatingResult.rating'
        db.delete_column('attestation_ratingresult', 'rating_id')
