...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Attestation.final_grade'
        db.delete_column('attestation_attestation', 'final_grade')

        # Adding field 'Attestation.final_grade'
        db.add_column('attestation_attestation', 'final_grade', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.RatingScaleItem'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Attestation.final_grade'
        raise RuntimeError(
            "Cannot reverse this migration. 'Attestation.final_grade' and its values cannot be restored.")

        # Deleting field 'Attestation.final_grade'
        db.delete_column('attestation_attestation', 'final_grade_id')
