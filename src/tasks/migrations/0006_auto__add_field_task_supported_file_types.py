...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.supported_file_types'
        db.add_column('tasks_task', 'supported_file_types', self.gf('django.db.models.fields.CharField')(default='^(text/.*|image/.*)$', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.supported_file_types'
        db.delete_column('tasks_task', 'supported_file_types')
