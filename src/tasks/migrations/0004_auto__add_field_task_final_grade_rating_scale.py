...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.final_grade_rating_scale'
        db.add_column('tasks_task', 'final_grade_rating_scale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.RatingScale'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.final_grade_rating_scale'
        db.delete_column('tasks_task', 'final_grade_rating_scale_id')
