...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tasks_mediafile', 'media_file', self.gf('django.db.models.fields.files.FileField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'MediaFile.media_file'
        db.alter_column('tasks_mediafile', 'media_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'tasks.mediafile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_file': ('django.db.models.fields.files.FileField', [], {'max_length': '500'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.Task']"})
        },
        'tasks.task': {
