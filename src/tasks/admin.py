...
class TaskAdmin(admin.ModelAdmin):
	...
	actions = ['export_tasks', 'run_all_checkers_on_finals', 'run_all_checkers_on_latest_only_failed', 'delete_attestations', 'unset_all_checker_finished', 'run_all_uploadtime_checkers_on_all']
