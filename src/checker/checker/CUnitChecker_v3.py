...
class IgnoringCBuilder3(CBuilder):
	_ignore = []
...
class IgnoringCXXBuilder3(CXXBuilder):
	_ignore = []
...
class CUCreateFileCheckerInline(GenericTabularInline):
    model = CreateFileChecker


class CUnitChecker3(Checker):
...
# https://sourceforge.net/projects/cppunit/
	...
	_ignore = models.CharField(max_length=4096, help_text=_("Regular Expression for ignoring files while compile and link test-code."),default="", blank=True)
