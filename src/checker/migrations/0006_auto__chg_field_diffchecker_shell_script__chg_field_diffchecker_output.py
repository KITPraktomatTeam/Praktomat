...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('checker_diffchecker', 'shell_script', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DiffChecker.output_file'
        db.alter_column('checker_diffchecker', 'output_file', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DiffChecker.input_file'
        db.alter_column('checker_diffchecker', 'input_file', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'JUnit3Checker.test_case'
        db.alter_column('checker_junit3checker', 'test_case', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DejaGnuSetup.test_defs'
        db.alter_column('checker_dejagnusetup', 'test_defs', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'CreateFileChecker.file'
        db.alter_column('checker_createfilechecker', 'file', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'ScriptChecker.shell_script'
        db.alter_column('checker_scriptchecker', 'shell_script', self.gf('checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DejaGnuTester.test_case'
        db.alter_column('checker_dejagnutester', 'test_case', self.gf('checker.models.CheckerFileField')(max_length=500))
