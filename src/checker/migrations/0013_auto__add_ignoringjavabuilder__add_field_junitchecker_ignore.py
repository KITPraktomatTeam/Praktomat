...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IgnoringJavaBuilder'
        db.create_table('checker_ignoringjavabuilder', (
            ('javabuilder_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['checker.JavaBuilder'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('checker', ['IgnoringJavaBuilder'])

        # Adding field 'JUnitChecker.ignore'
        db.add_column('checker_junitchecker', 'ignore',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4096),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'IgnoringJavaBuilder'
        db.delete_table('checker_ignoringjavabuilder')

        # Deleting field 'JUnitChecker.ignore'
        db.delete_column('checker_junitchecker', 'ignore')
