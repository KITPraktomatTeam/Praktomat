...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='ignore',
            field=models.CharField(default=b'', help_text='space-separated list of files to be ignored during compilation', max_length=4096, blank=True),
        ),
        migrations.AlterField(
            model_name='haskelltestframeworkchecker',
            name='include_testcase_in_report',
            field=models.CharField(default=b'DL', help_text='Make the testcases source available via the checkers result report?', max_length=4, choices=[(b'DL', b'Download-Link only'), (b'NO', b'Do not make the testcases source available'), (b'FULL', b'Also copy the source into the report')]),
        ),
        migrations.AlterField(
            model_name='haskelltestframeworkchecker',
            name='order',
        ...
        migrations.AlterField(
            ...
            name='exclude',
            field=models.CharField(default=b'.*\\.txt$', help_text='Regular expression describing included filenames, which shall be excluded. Case insensitive. Blank: use all files.', max_length=100, blank=True),
        ),
        migrations.AlterField(
            model_name='linewidthchecker',
            name='include',
            field=models.CharField(default=b'.*', help_text='Regular expression describing the filenames to be checked. Case insensitive. Blank: use all files.', max_length=100, blank=True),
        ),
        migrations.AlterField(
            model_name='linewidthchecker',
            name='order',
