...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JavaBuilder.order'
        db.add_column('checker_javabuilder', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'DiffChecker.order'
        db.add_column('checker_diffchecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'AnonymityChecker.order'
        db.add_column('checker_anonymitychecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'JavaGCCBuilder.order'
        db.add_column('checker_javagccbuilder', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TextChecker.order'
        db.add_column('checker_textchecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CBuilder.order'
        db.add_column('checker_cbuilder', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'InterfaceChecker.order'
        db.add_column('checker_interfacechecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CheckStyleChecker.order'
        db.add_column('checker_checkstylechecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'DejaGnuSetup.order'
        db.add_column('checker_dejagnusetup', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CreateFileChecker.order'
        db.add_column('checker_createfilechecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'FortranBuilder.order'
        db.add_column('checker_fortranbuilder', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'LineWidthChecker.order'
        db.add_column('checker_linewidthchecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ScriptChecker.order'
        db.add_column('checker_scriptchecker', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'DejaGnuTester.order'
        db.add_column('checker_dejagnutester', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'LineCounter.order'
        db.add_column('checker_linecounter', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CXXBuilder.order'
        db.add_column('checker_cxxbuilder', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JavaBuilder.order'
        db.delete_column('checker_javabuilder', 'order')

        # Deleting field 'DiffChecker.order'
        db.delete_column('checker_diffchecker', 'order')

        # Deleting field 'AnonymityChecker.order'
        db.delete_column('checker_anonymitychecker', 'order')

        # Deleting field 'JavaGCCBuilder.order'
        db.delete_column('checker_javagccbuilder', 'order')

        # Deleting field 'TextChecker.order'
        db.delete_column('checker_textchecker', 'order')

        # Deleting field 'CBuilder.order'
        db.delete_column('checker_cbuilder', 'order')

        # Deleting field 'InterfaceChecker.order'
        db.delete_column('checker_interfacechecker', 'order')

        # Deleting field 'CheckStyleChecker.order'
        db.delete_column('checker_checkstylechecker', 'order')

        # Deleting field 'DejaGnuSetup.order'
        db.delete_column('checker_dejagnusetup', 'order')

        # Deleting field 'CreateFileChecker.order'
        db.delete_column('checker_createfilechecker', 'order')

        # Deleting field 'FortranBuilder.order'
        db.delete_column('checker_fortranbuilder', 'order')

        # Deleting field 'LineWidthChecker.order'
        db.delete_column('checker_linewidthchecker', 'order')

        # Deleting field 'ScriptChecker.order'
        db.delete_column('checker_scriptchecker', 'order')

        # Deleting field 'DejaGnuTester.order'
        db.delete_column('checker_dejagnutester', 'order')

        # Deleting field 'LineCounter.order'
        db.delete_column('checker_linecounter', 'order')

        # Deleting field 'CXXBuilder.order'
        db.delete_column('checker_cxxbuilder', 'order')
