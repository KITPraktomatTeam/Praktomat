...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JUnitChecker.junit_version'
        db.add_column('checker_junitchecker', 'junit_version',
                      self.gf('django.db.models.fields.CharField')(default='junit3', max_length=16),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JUnitChecker.junit_version'
        db.delete_column('checker_junitchecker', 'junit_version')
