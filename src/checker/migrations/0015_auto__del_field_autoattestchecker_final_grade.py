...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AutoAttestChecker.final_grade'
        db.delete_column('checker_autoattestchecker', 'final_grade_id')


    def backwards(self, orm):
        # Adding field 'AutoAttestChecker.final_grade'
        db.add_column('checker_autoattestchecker', 'final_grade',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attestation.RatingScaleItem'], null=True),
                      keep_default=False)
