...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HaskellTestFrameWorkChecker'
        db.create_table('checker_haskelltestframeworkchecker', (
            ...
            ('ignore', self.gf('django.db.models.fields.CharField')(default='', max_length=4096, blank=True)),
            ('require_safe', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('checker', ['HaskellTestFrameWorkChecker'])

        # Adding model 'IgnoringHaskellBuilder'
        db.create_table('checker_ignoringhaskellbuilder', (
            ('haskellbuilder_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['checker.HaskellBuilder'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('checker', ['IgnoringHaskellBuilder'])

        # Adding model 'TestOnlyBuildingBuilder'
        db.create_table('checker_testonlybuildingbuilder', (
            ('haskellbuilder_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['checker.HaskellBuilder'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('checker', ['TestOnlyBuildingBuilder'])


    def backwards(self, orm):
        # Deleting model 'HaskellTestFrameWorkChecker'
        db.delete_table('checker_haskelltestframeworkchecker')

        # Deleting model 'IgnoringHaskellBuilder'
        db.delete_table('checker_ignoringhaskellbuilder')

        # Deleting model 'TestOnlyBuildingBuilder'
        db.delete_table('checker_testonlybuildingbuilder')
