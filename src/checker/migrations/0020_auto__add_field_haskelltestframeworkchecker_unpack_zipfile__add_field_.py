...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HaskellTestFrameWorkChecker.unpack_zipfile'
        db.add_column('checker_haskelltestframeworkchecker', 'unpack_zipfile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CreateFileChecker.unpack_zipfile'
        db.add_column('checker_createfilechecker', 'unpack_zipfile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HaskellTestFrameWorkChecker.unpack_zipfile'
        db.delete_column('checker_haskelltestframeworkchecker', 'unpack_zipfile')

        # Deleting field 'CreateFileChecker.unpack_zipfile'
        db.delete_column('checker_createfilechecker', 'unpack_zipfile')
