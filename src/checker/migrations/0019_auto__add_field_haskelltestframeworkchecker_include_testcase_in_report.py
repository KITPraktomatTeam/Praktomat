...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HaskellTestFrameWorkChecker.include_testcase_in_report'
        db.add_column('checker_haskelltestframeworkchecker', 'include_testcase_in_report',
                      self.gf('django.db.models.fields.CharField')(default='DL', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HaskellTestFrameWorkChecker.include_testcase_in_report'
        db.delete_column('checker_haskelltestframeworkchecker', 'include_testcase_in_report')
