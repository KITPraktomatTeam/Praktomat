...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JUnitChecker.name'
        db.add_column('checker_junitchecker', 'name',
                      self.gf('django.db.models.fields.CharField')(default='<Insert Name Here>', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JUnitChecker.name'
        db.delete_column('checker_junitchecker', 'name')
