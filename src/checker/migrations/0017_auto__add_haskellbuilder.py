...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HaskellBuilder'
        db.create_table('checker_haskellbuilder', (
            ...
            ('_main_required', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('checker', ['HaskellBuilder'])


    def backwards(self, orm):
        # Deleting model 'HaskellBuilder'
        db.delete_table('checker_haskellbuilder')
