...
from checker import  CreateFileChecker
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreateFileChecker.filename'
        db.add_column('checker_createfilechecker', 'filename', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'CreateFileChecker.filename'
        db.delete_column('checker_createfilechecker', 'filename')
