...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Solution.author'
        db.alter_column('solutions_solution', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))


    def backwards(self, orm):
        
        # Changing field 'Solution.author'
        db.alter_column('solutions_solution', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
