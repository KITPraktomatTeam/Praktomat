...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solution.testupload'
        db.add_column(u'solutions_solution', 'testupload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solution.testupload'
        db.delete_column(u'solutions_solution', 'testupload')
