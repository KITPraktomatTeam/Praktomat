...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for solution in orm.Solution.objects.order_by('id'):
			solution.number = (solution.task.solution_set.filter(author=solution.author).aggregate(Max('number'))['number__max'] or 0) + 1
			solution.save()
