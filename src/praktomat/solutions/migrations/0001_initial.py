...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('solutions_solution', (
            ...
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('solutions', ['Solution'])

        # Adding model 'SolutionFile'
        db.create_table('solutions_solutionfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('solution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['solutions.Solution'])),
        ))
        db.send_create_signal('solutions', ['SolutionFile'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SolutionFile'
        db.delete_table('solutions_solutionfile')
