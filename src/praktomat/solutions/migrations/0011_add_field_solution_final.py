...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
		...
		if db.backend_name == "sqlite3":
			...
			default = False
		# Adding field 'Solution.final'
		db.add_column('solutions_solution', 'final', self.gf('django.db.models.fields.BooleanField')(default=default), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Solution.final'
        db.delete_column('solutions_solution', 'final')
