...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SolutionFile.file'
        db.alter_column('solutions_solutionfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'SolutionFile.file'
        db.alter_column('solutions_solutionfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
