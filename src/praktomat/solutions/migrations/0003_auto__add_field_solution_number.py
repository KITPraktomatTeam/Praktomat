...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Solution.number'
        db.add_column('solutions_solution', 'number', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Solution.number'
        db.delete_column('solutions_solution', 'number')
