...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LineWidthChecker.tab_width'
        db.add_column('checker_linewidthchecker', 'tab_width', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LineWidthChecker.tab_width'
        db.delete_column('checker_linewidthchecker', 'tab_width')
