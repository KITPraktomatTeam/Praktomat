...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiffChecker.shell_script'
        db.alter_column('checker_diffchecker', 'shell_script', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DiffChecker.output_file'
        db.alter_column('checker_diffchecker', 'output_file', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DiffChecker.input_file'
        db.alter_column('checker_diffchecker', 'input_file', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'JUnit3Checker.test_case'
        db.alter_column('checker_junit3checker', 'test_case', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DejaGnuSetup.test_defs'
        db.alter_column('checker_dejagnusetup', 'test_defs', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'CreateFileChecker.file'
        db.alter_column('checker_createfilechecker', 'file', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'ScriptChecker.shell_script'
        db.alter_column('checker_scriptchecker', 'shell_script', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))

        # Changing field 'DejaGnuTester.test_case'
        db.alter_column('checker_dejagnutester', 'test_case', self.gf('praktomat.checker.models.CheckerFileField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'DiffChecker.shell_script'
        db.alter_column('checker_diffchecker', 'shell_script', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'DiffChecker.output_file'
        db.alter_column('checker_diffchecker', 'output_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'DiffChecker.input_file'
        db.alter_column('checker_diffchecker', 'input_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'JUnit3Checker.test_case'
        db.alter_column('checker_junit3checker', 'test_case', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'DejaGnuSetup.test_defs'
        db.alter_column('checker_dejagnusetup', 'test_defs', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'CreateFileChecker.file'
        db.alter_column('checker_createfilechecker', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'ScriptChecker.shell_script'
        db.alter_column('checker_scriptchecker', 'shell_script', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'DejaGnuTester.test_case'
        db.alter_column('checker_dejagnutester', 'test_case', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'checker.createfilechecker': {
            ...
            'always': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'file': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
        ...
        'checker.dejagnusetup': {
            ...
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.Task']"}),
            'test_defs': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500'})
        },
        'checker.dejagnutester': {
            ...
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.Task']"}),
            'test_case': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500'})
        },
        'checker.diffchecker': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_file': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'output_file': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500', 'blank': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'shell_script': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500'}),
            'task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.Task']"})
        },
