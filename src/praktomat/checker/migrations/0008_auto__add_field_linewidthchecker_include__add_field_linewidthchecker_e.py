...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LineWidthChecker.include'
        db.add_column('checker_linewidthchecker', 'include', self.gf('django.db.models.fields.CharField')(default='.*', max_length=100, blank=True), keep_default=False)

        # Adding field 'LineWidthChecker.exclude'
        db.add_column('checker_linewidthchecker', 'exclude', self.gf('django.db.models.fields.CharField')(default='.*\\.txt$', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LineWidthChecker.include'
        db.delete_column('checker_linewidthchecker', 'include')

        # Deleting field 'LineWidthChecker.exclude'
        db.delete_column('checker_linewidthchecker', 'exclude')
    ...
    models = {
        ...
        'checker.checkstylechecker': {
            ...
            'always': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'configuration': ('praktomat.checker.models.CheckerFileField', [], {'max_length': '500'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
