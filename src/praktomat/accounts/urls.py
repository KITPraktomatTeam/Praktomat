...
urlpatterns = patterns('',
	...
	url(r'^change/$', 'praktomat.accounts.views.change', name='registration_change'),				   
	...
	url(r'^register/$', 'praktomat.accounts.views.register', name='registration_register'),
	url(r'^register/complete/$', direct_to_template, {'template': 'registration/registration_complete.html'}, name='registration_complete'),
	url(r'^activate/(?P<activation_key>.+)/$', 'praktomat.accounts.views.activate', name='registration_activate'),
)
