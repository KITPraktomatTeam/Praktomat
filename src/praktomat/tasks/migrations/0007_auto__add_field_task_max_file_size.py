...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.max_file_size'
        db.add_column('tasks_task', 'max_file_size', self.gf('django.db.models.fields.IntegerField')(default=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.max_file_size'
        db.delete_column('tasks_task', 'max_file_size')
