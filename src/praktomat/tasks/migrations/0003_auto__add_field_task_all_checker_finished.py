...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.all_checker_finished'
        db.add_column('tasks_task', 'all_checker_finished', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.all_checker_finished'
        db.delete_column('tasks_task', 'all_checker_finished')
