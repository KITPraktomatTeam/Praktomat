...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.model_solution'
        db.add_column('tasks_task', 'model_solution', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='yetAnotherTaskLink', unique=True, null=True, to=orm['solutions.Solution']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Task.model_solution'
        db.delete_column('tasks_task', 'model_solution_id')
