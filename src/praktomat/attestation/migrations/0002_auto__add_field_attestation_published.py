...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attestation.published'
        db.add_column('attestation_attestation', 'published', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Attestation.published'
        db.delete_column('attestation_attestation', 'published')
