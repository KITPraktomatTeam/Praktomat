...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attestation.public_comment'
        db.alter_column('attestation_attestation', 'public_comment', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Attestation.final_grade'
        db.alter_column('attestation_attestation', 'final_grade', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Attestation.public_comment'
        db.alter_column('attestation_attestation', 'public_comment', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Attestation.final_grade'
        db.alter_column('attestation_attestation', 'final_grade', self.gf('django.db.models.fields.CharField')(max_length=2, blank=True))
