...
SITE_NAME = 'Praktomat Wintersemester 2014'
...
ADMINS = [
		  ...
		  ('Stephan Baum', 'sbaum2m+admin@inf.h-brs.de')
		  ]

DATABASE_ENGINE = 'postgresql_psycopg2'    # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'praktomat_2014w'   # Or path to database file if using sqlite3.
...
FORTRAN_BINARY = 'g77'
ISABELLE_BINARY = '/data1/praktomat/Isabelle2013/bin/isabelle'
